  ...
  const importanceReasons = [
    {
      ...
      description: "Yabancıların Türkiye'de yasal olarak çalışabilmesi için bu izin şarttır",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: "İşveren Sorumluluğu",
      description: "İşverenlerin yasal yükümlülüklerini yerine getirdiğinin kanıtıdır",
      icon: <Scale className="w-6 h-6" />,
    },
    {
      title: "İşletme Sürekliliği",
      description: "Farklı bakış açıları ve uzmanlıklar getirerek rekabet avantajı sağlar",
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-teal-900 mb-8">
              Yabancı personel çalışma izinlerinde belirtilen koşullar, sınırlamalar ve uyulması gereken hususlar
            </p>
            ...
            <Card className="shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Çalışma İzni Şerhleri Nedir?</h2>
                    <p className="text-gray-600 leading-relaxed mb-4">
                      Yabancı Personel Çalışma İzni Şerhleri, Türkiye'de yabancıların çalışma hayatına ilişkin önemli
                      bir detayı oluşturur. Bu şerhler, çalışma izinlerinin verildiği koşulları, sınırlamaları ve izin
                      süresince uyulması gereken hususları belirtir.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-4">
                      Türkiye'de işletmelerin büyümesi ve küreselleşmeyle birlikte yabancı personel çalışma izni
                      şerhleri konusu giderek önem kazanmaktadır. Bu şerhler, hem yabancının yasal olarak çalışmasını
                      sağlar hem de işverenin yasal yükümlülüklerini yerine getirmesine yardımcı olur.
                    </p>
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                      <p className="text-yellow-800 font-medium">
                        <strong>Önemli:</strong> Çalışma Bakanlığı, bu izinlerin verilmesi ve takip edilmesi konusunda
                        yetkili kurumdur.
                      </p>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Neden Bu Kadar Önemli?</h2>
              <p className="text-gray-600">Yabancılar için çalışma izni şerhlerinin kritik önemi</p>
            </div>
            ...
            <Card className="border-orange-200 bg-orange-50">
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Uyulması Gereken Zorunlu Şerhler</h2>
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Çalışma izin kartlarınızda belirtilen numaralar ve açıklamalara uyulması zorunludur. Bu kurallara
                      uyulmaması durumunda ortaya çıkabilecek yasal ve cezai işlemlerden işveren ve/veya yabancı
                      personel sorumlu olacaktır.
                    </p>
                    <div className="flex items-center space-x-2 text-orange-700">
                      <Eye className="w-5 h-5" />
                      <span className="font-medium">Dikkatli inceleme ve tam uyum gereklidir!</span>
                    </div>
                  </div>
                </div>
              </CardContent>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Şerh Detayları</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              {annotationsData.map((annotation, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-lg text-gray-900 mb-2">{annotation.title}</CardTitle>
                  ...
                  <CardContent>
                    <p className="text-gray-600 text-sm leading-relaxed">{annotation.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Diğer Önemli Şerhler</h2>
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  description: "İşbu çalışma izni ile yabancı şahıs Tıp Doktorluğu mesleğini icra edemez.",
                  icon: <Stethoscope className="w-5 h-5" />,
                },
                {
                  number: "26",
      ...
      <section className="py-16 bg-teal-100/95 text-teal-900">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold mb-4">Şerhlerinizi Kontrol Edin</h2>
            <p className="text-xl text-teal-900 mb-8">
              Çalışma izninizde belirtilen şerhleri dikkatlice inceleyerek yasal yükümlülüklerinizi öğrenin
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                className="bg-teal-700 hover:bg-teal-900 text-white w-[180px] font-medium py-3"
              >
                Detaylı Bilgi Al
              </Button>
            </div>
